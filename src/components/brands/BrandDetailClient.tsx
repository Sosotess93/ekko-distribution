...
import { getBrandById, getProductsByBrand, productsData } from "@/data";

interface BrandDetailClientProps {
  brandId: string;
}

export default function BrandDetailClient({ brandId }: BrandDetailClientProps) {
  ...
  const otherBrands = productsData.brands
      ...
      <div className="pt-20 min-h-screen flex items-center justify-center bg-beige/30">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-dark-green mb-4">
            {locale === "fr" ? "Marque non trouv\u00e9e" : "Brand not found"}
          </h1>
  ...
  return (
    <div className="pt-20 bg-beige/30 min-h-screen">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-dark-green mb-8">
            {locale === "fr" ? "Autres marques" : "Other brands"}
          </h2>
